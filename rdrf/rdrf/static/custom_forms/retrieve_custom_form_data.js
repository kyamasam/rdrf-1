...
export async function retrieveAllVisitsFormioFormData(
  formName = "testForm",
  patientId,
  registryId,
  showError = false
  ...
  return $.ajax({
    url: `/api/custom-form-data/get-custom-form-data?patient_id=${patientId}&registry_id=${registryId}&form_code=${formName}&all_visits=true`,
    type: "GET",
    contentType: "application/json",
    success: function (response) {
      // Show success message
